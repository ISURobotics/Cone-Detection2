...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_0_hue = [0.0, 13]
        self.__hsv_threshold_0_saturation = [90, 255.0]
        self.__hsv_threshold_0_value = [62, 255.0]

        self.hsv_threshold_0_output = None


        self.__hsv_threshold_1_hue = [169.9640287769784, 180.0]
        self.__hsv_threshold_1_saturation = [70, 255.0]
        self.__hsv_threshold_1_value = [60, 255.0]
